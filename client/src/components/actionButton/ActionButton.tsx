...
const ActionButton = ({ text }: ActionButtonProps) => {
    return (
        <button className="group relative cursor-pointer">
            <div className="relative z-1 inline-flex h-8 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-white transition-all duration-300 group-hover:-translate-x-1 group-hover:-translate-y-1 group-active:translate-x-0 group-active:translate-y-0">
                {text}
            </div>
