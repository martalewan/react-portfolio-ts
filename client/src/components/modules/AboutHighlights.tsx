        ...
        <div className="relative mb-24 lg:mb-40 space-y-20 lg:space-y-0">
            <div className="relative w-full lg:w-[45%]">
                <NeonFrame>
                    ...
                    <p className="mt-4 text-(--secondary-color)/80">
            ...
            <div className="relative w-full lg:w-[45%] ml-auto -mt-12">
                <NeonFrame>
                    ...
                    <p className="mt-4 text-(--secondary-color)/80">
                        My path from design to engineering has been <span className="font-medium text-white/90">intentional and continuous</span>.
