...
const Navbar = () => {
    return (
        <>
            <nav className="w-full fixed flex items-center h-17 px-7 z-10 bg-linear-to-b from-(--color-bg) to-(--color-bg-muted) backdrop-blur-md border-b border-(--color-border)/5">
