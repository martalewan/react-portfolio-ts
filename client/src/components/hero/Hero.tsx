            ...
            <div className="container mx-auto">
                <div className="h-full flex flex-col xl:flex-row justify-center xl:justify-between items-center gap-6">
                    ...
                    <div className="relative w-52 xl:w-130 flex justify-center items-center">
                        <motion.div
                            className="absolute w-50 h-50 xl:w-130 xl:h-130 bg-pink-500 rounded-full opacity-50"
                            initial={{ x: -50, y: -50 }}
                            animate={{ x: [0, 50, -50], y: [0, -30, 30] }}
                            transition={{ duration: 10, repeat: Infinity, repeatType: "mirror" }}
                        />
                        <motion.div
                            className="absolute w-50 h-50 xl:w-130 xl:h-130 bg-teal-400 rounded-full opacity-30"
                            initial={{ x: 50, y: 50 }}
